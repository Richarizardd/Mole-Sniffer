 ...
 */
public class Line {
    private final PointFloat _start;
    private final PointFloat _end;
    private float _a = Float.NaN;
    private float _b = Float.NaN;
    private boolean _vertical = false;

    public Line(PointFloat start, PointFloat end) {
        _start = start;
        _end = end;
     ...
     */
    public boolean isInside(PointFloat point) {
